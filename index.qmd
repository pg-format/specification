...
*THIS IS WORK IN PROGRESS*. See also [discussion forum](https://github.com/orgs/pg-format/discussions) and 
[issue tracker](https://github.com/pg-format/specification/issues) for updates!
...
/* 3.6 Properties */
Key            ::= QuotedKey | UnquotedKey DW | UnquotedKey2
QuotedKey      ::= QuotedNonEmpty ":"
UnquotedKey    ::= UnquotedStart ( ( !":" UnquotedChar )* ":" )+
UnquotedKey2   ::= UnquotedStart ( !":" UnquotedChar )* ":"
...
- [PG Test Suite](https://github.com/pg-format/pg-test-suite)
...
- **Version 0.3**
  ...
  Less formal specification published in 2019. See [latest version from 2020](https://pg-format.readthedocs.io/en/0.3/contents/pg-format.html).
