...
Labels of a node or edge are a sorted set, so the following two statements are
equivalent:

~~~
a :label1 :label2 :label1
a :label1 :label2
~~~
...
**Space** is a non-empty sequence of space (`U+0020`) and/or tabular (`U+0009`).
