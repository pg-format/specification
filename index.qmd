...
Statements are separated from each other with a [line break](#whitespace).
Optional [spaces](#whitespace) and/or a [comment](#whitespace) at the end of
a statement are ignored.
...
[edge](#edges), a [label](#labels), or the name of a [properties](#properties).
Identifiers can be given as [quoted string](#quoted-strings) or as unquoted
identifier.
...
~~~{.pg .invalid #lst-invalid-id lst-cap="Invalid identifier"}
:id
~~~

An unquoted identifier cannot start with "#" because this starts
a [comment](#whitespace) nor with "'" because this starts a [quoted
